...
public class Game {
    ...
    public static string CompareGuessToCode(string guess, string codeStr) {
        ...
        // NOTE: This function has many Unit Tests located at Mastermind-Tests/TestCompareGuessToCode.cs
        // To run the tests, open a terminal, navigate to Mastermind, and run:
